  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen gap-10  p-10">
      ...
      <form onSubmit={(e)=>{
        ...
        <input type="email" className="bg-primary-700 rounded-lg p-4 pl-16" placeholder="Email" />
        <input type="password" placeholder="Password" className="bg-primary-700 rounded-lg p-4 pl-16" />
